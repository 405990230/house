                                ...
                                <section id="agent-testimonials">
                                    ...
                                    <div class="owl-carousel testimonials-carousel small">
                                        <blockquote class="testimonial">
                                            ...
                                            <aside class="cite">
                                                <p>Fusce risus metus, placerat in consectetur eu, porttitor a est sed
                                                    sed dolor lorem cras adipiscing</p>
                                ...
                                <div class="agent-form">
                                    <form role="form" id="form-contact-agent" method="post" class="clearfix"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control"
                                                           id="form-contact-agent-email" name="email" required>
                                                </div><!-- /.form-group -->
                                            </div><!-- /.col-md-6 -->
                                        </div><!-- /.row -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="form-contact-agent-message">Your
                                                        Message<em>*</em></label>
