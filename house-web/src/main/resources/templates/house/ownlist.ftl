                    ...
                    <section id="sidebar">
                        ...
                        <aside>
                            <ul class="sidebar-navigation">
                                ...
                                <li <#if  pageType != "book">  class="active" </#if> ><a href="/house/ownlist"><i
                                        class="fa fa-home"></i><span>我的房产信息</span></a></li>
                                <li <#if  pageType == "book"> class="active" </#if>><a href="/house/bookmarked"><i
                                        class="fa fa-heart"></i><span>房产收藏 </span></a></li>
                            </ul>
                        </aside>
                    </section><!-- /#sidebar -->
                </div><!-- /.col-md-3 -->
                        ...
                        <div class="my-properties">
                            <div class="table-responsive">
                                <table class="table">
                                 ...
                                 <tr>
                                     <td class="image">
                                         <a href="/house/detail?id=${house.id}"><img alt="" src="${house.firstImg}"
                                                                                     style="width: 105px;height: 78px"></a>
                                     </td>
                                     <td>
                                         <div class="inner">
                                     ...
                                     <td class="actions">
                                         <a href="/house/del?id=${house.id}&pageType=${pageType}"><i
                                                 class="delete fa fa-trash-o"></i></a>
                                     </td>
                                 </tr>
                                 </#list>
                                    </tbody>
